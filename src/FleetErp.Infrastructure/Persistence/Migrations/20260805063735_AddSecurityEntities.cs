        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    LookupType = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokedReason = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lookup_items_LookupType",
                table: "lookup_items",
                column: "LookupType");

            migrationBuilder.CreateIndex(
                name: "IX_lookup_items_LookupType_Code",
                table: "lookup_items",

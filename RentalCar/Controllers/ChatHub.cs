    ...
    public class ChatHub : Microsoft.AspNetCore.SignalR.Hub
    {
        ...
        public async Task JoinRoom(UserRoomConnection userConnection)
        {
            ...
            await Clients.Group(userConnection.Room!)
                .SendAsync("ReceiveMessage", "Lets Chat ", $"{userConnection.User} has Joined the Group", DateTime.Now);
        ...
        public override Task OnDisconnectedAsync(Exception? exp)
        {
            ...
            Clients.Group(roomConnection.Room!)
                .SendAsync("ReceiveMessage", "Lets Chat", $"{roomConnection.User} has Left the Group", DateTime.Now);
